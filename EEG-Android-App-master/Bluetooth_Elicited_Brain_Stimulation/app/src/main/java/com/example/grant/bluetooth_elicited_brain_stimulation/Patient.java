...
public class Patient implements Parcelable{
    ...
    public int getClinician() { return mClinician;}

    public void setClinician(int clinician) {mClinician = clinician;}
